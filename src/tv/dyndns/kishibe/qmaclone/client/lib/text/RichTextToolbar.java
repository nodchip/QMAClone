 ...
 * the License.
 */
package tv.dyndns.kishibe.qmaclone.client.lib.text;
...
public class RichTextToolbar extends Composite {
	 ...
	 * these images to be packed into a single image, which saves a lot of HTTP requests,
	...
	private static final RichTextArea.FontSize[] fontSizesConstants = new RichTextArea.FontSize[] {
			...
			RichTextArea.FontSize.SMALL, RichTextArea.FontSize.MEDIUM, RichTextArea.FontSize.LARGE,

...
public class LobbyUi extends Composite {
	...
	static final List<String> LEVEL_NAMES = ImmutableList.of("修練", "見習", "初級", "中級", "上級", "魔導",
			"大魔導", "賢者", "大賢者", "青銅", "白銀", "黄金", "白金", "金剛", "天青", "紅玉", "翡翠", "黄玉", "紫宝", "琥珀",
			"瑠璃");
	...
	public LobbyUi(SceneLobby sceneRegistration) {
		...
		multiItemSelectorType = new WidgetMultiItemSelector<ProblemType>("出題形式",
				ProblemType.values(), 4);
	...
	public void setPlayerRecord() {
		...
		spanClass
				.setInnerText("(" + classLevel + ")" + Constant.getClassName(classNameIndex) + "組");
	}
	...
	private void setEnabled(boolean enabled) {
		FocusWidget[] widgets = { listBoxLevelNumber, listBoxLevelName, listBoxPrefecture,
				...
				buttonGameVsCom, buttonGameAllClass, buttonGameEvent, buttonGameTheme,
				textBoxEventName, buttonShowEventRooms, checkBoxPublicEvent, listBoxTheme,
				buttonShowUserCode, };

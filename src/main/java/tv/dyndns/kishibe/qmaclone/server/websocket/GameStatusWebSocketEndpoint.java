...
/**
 * ゲーム状態配信用の WebSocket エンドポイント
 */
@ServerEndpoint("/websocket/tv.dyndns.kishibe.qmaclone.client.packet.PacketGameStatus")
public class GameStatusWebSocketEndpoint {
  private static final Logger logger = Logger.getLogger(GameStatusWebSocketEndpoint.class.getName());
  ...
  public void onError(Session session, Throwable cause) {
    logger.log(Level.WARNING,
        "ゲーム状態 WebSocket セッションでエラーが発生しました。remoteAddress="

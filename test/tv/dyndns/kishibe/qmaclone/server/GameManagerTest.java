...
public class GameManagerTest {
	...
	public void getOrCreateMatchingSessionShouldReturnNewMatchingGameSessionIfFull() {
		when(mockGameFactory.create(1, 0, false, false, null, false)).thenReturn(mockGame1);
		when(mockGameFactory.create(2, 0, false, false, null, false)).thenReturn(mockGame2);
		...
		assertEquals(ImmutableList.of(mockGame1, mockGame1, mockGame1, mockGame1, mockGame1,
				mockGame1, mockGame1, mockGame1, mockGame2), games);
	}
	...
	public void getPublicMatchingEventRooms() {
		when(mockGameFactory.create(1, 0, true, false, null, true)).thenReturn(mockGame1);
		...
		when(mockGameFactory.create(3, 0, false, false, null, false)).thenReturn(mockGame3);
		...
		when(mockGameFactory.create(4, 0, true, false, null, true)).thenReturn(mockGame3);
